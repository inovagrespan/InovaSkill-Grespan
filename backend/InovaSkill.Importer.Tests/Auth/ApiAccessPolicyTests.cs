...
public sealed class ApiAccessPolicyTests
{
    ...
    [InlineData(AppUserRoles.Diretor, "/api/route-optimizations", "GET", true)]
    [InlineData(AppUserRoles.Vendas, "/api/route-optimizations/simulate", "POST", true)]
    [InlineData(AppUserRoles.Diretor, "/api/route-optimizations/simulate", "POST", false)]
    [InlineData(AppUserRoles.Vendas, "/api/route-optimizations/00000000-0000-0000-0000-000000000001/remediation", "GET", true)]
    [InlineData(AppUserRoles.Diretor, "/api/route-optimizations/00000000-0000-0000-0000-000000000001/remediations", "POST", true)]
    [InlineData(AppUserRoles.Vendas, "/api/route-optimizations/00000000-0000-0000-0000-000000000001/remediations", "POST", true)]
    [InlineData(AppUserRoles.Logistica, "/api/route-optimizations/00000000-0000-0000-0000-000000000001/remediations", "POST", true)]
    [InlineData(AppUserRoles.Admin, "/api/route-optimizations/remediations/00000000-0000-0000-0000-000000000001/retry", "POST", true)]
