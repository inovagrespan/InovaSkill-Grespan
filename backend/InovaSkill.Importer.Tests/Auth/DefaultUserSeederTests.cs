...
public sealed class DefaultUserSeederTests
{
    ...
    public async Task EnsureDefaultUsersAsync_CreatesAreaManagersDirectorAndRhAdminWithMatchingPasswords()
    {
        ...
        AssertSeededUser(db, passwordHasher, "producao", "producao", AppUserRoles.Producao);
        AssertSeededUser(db, passwordHasher, "administrativo", "administrativo", AppUserRoles.Administrativo);
