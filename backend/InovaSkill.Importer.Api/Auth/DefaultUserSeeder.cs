...
public sealed class DefaultUserSeeder(ImportDbContext db, PasswordHasher<AppUser> passwordHasher)
{
    ...
    [
        ...
        new("producao", "producao@local.test", "producao", AppUserRoles.Producao),
        new("administrativo", "administrativo@local.test", "administrativo", AppUserRoles.Administrativo),
