...
internal sealed class SalesInvoiceSpreadsheetImportPattern : SpreadsheetImportPattern
{
    ...
    [
        ...
        Text("vendedor codigo", "suppliercode", false, "suppliercode", "seller code", "codigo vendedor", "cod vendedor", "codigo representante", "cod representante", "codigo fornecedor"),
        Text("vendedor", "suppliername", false, "suppliername", "seller name", "vendedor", "nome vendedor", "representante", "nome representante", "fornecedor", "nome fornecedor"),
        Text("rota", "routename", false, "routename", "route name", "rota", "nome rota", "rota comercial"),
