...
import { Activity, BarChart3, ChevronLeft, ChevronRight, FileUp, LayoutDashboard, LogOut, Menu, Moon, Package, ReceiptText, ServerCog, SlidersHorizontal, Sun, TrendingUp, Truck, Users } from "lucide-react";
