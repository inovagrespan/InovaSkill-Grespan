...
const steps = [
  {
    ...
    text: "Cada área acompanha seus KPIs com filtros, comparativos e alertas inteligentes. A IA sinaliza anomalias antes que virem retrabalho.",
    icon: TrendingUp,
  },
  {
    step: "02",
    title: "Reuniões com continuidade",
    text: "Pauta, problemas, decisões e ações ficam registrados com responsável, prazo e histórico. Nunca mais uma reunião sem desfecho.",
    icon: CalendarCheck,
  },
  {
    step: "03",
    title: "Acompanhamento diário",
    text: "Alertas e pendências cruzam indicadores com reuniões. A diretoria enxerga o que foi decidido, o que foi feito e o que está em risco.",
    icon: ClipboardCheck,
  },
] as const;
...
const modules = [
  ...
  { label: "Produção", icon: Factory, desc: "Ordens, capacidade, gargalos e eficiência operacional." },
  { label: "Reuniões", icon: UsersRound, desc: "Pauta, decisões, pendências críticas e encaminhamentos." },
] as const;
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4 py-16 md:py-20">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-5 font-display text-3xl font-bold tracking-tight md:text-5xl">
              ...
              <span className="text-[#d01825]">execução</span>.
            </h2>
            <p className="mt-4 text-sm leading-7 text-slate-500 dark:text-slate-400">
              O Conecta360 substitui o acompanhamento reativo por um fluxo contínuo: os
              indicadores geram alertas, as reuniões produzem decisões, e as ações têm dono
              e prazo — tudo visível para quem precisa.
            </p>
          </div>
      ...
      >
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4 py-16 md:py-20">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-5 font-display text-3xl font-bold tracking-tight md:text-5xl">
              Cada área vê sua rotina, a diretoria vê o{" "}
              <span className="text-[#d01825]">conjunto</span>.
            </h2>
            <p className="mt-4 text-sm leading-7 text-slate-500 dark:text-slate-400">
              Módulos independentes que compartilham a mesma base de reuniões, alertas e
              indicadores — integrados de verdade.
            </p>
          </div>
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4 py-16 md:py-20">
          <div className="grid gap-12 lg:grid-cols-[1fr_1fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-5 font-display text-3xl font-bold tracking-tight md:text-5xl">
                Acompanhamento vira rotina, não{" "}
                <span className="text-[#d01825]">cobrança de última hora</span>.
              </h2>
