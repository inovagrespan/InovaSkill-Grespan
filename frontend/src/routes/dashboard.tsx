...
import { ArrowRight, BarChart3, BellRing, Boxes, CalendarCheck, CircleDollarSign, Truck } from "lucide-react";
  ...
  return (
    <div className="page-shell">
      <header className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between animate-soft-enter">
        <div>
          <span className="page-header-kicker">Torre de Controle</span>
