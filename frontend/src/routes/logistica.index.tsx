  ...
  return (
    <div className="page-shell app-background space-y-6">
      <header className="animate-fade-in flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <div className="flex flex-wrap items-center gap-2"><span className="page-header-kicker">Logística</span><Badge variant="outline">Base demonstrativa</Badge></div>
          <h1 className="mt-1 text-3xl font-display font-semibold tracking-tight">Saúde logística</h1>
