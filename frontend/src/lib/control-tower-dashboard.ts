...
export type ControlTowerModule = "Vendas" | "Produtos" | "Finanças" | "Logística" | "Alertas" | "Reuniões";
...
const scenarios: Record<ControlTowerPeriod, ControlTowerScenario> = {
  today: {
    ...
    cards: [
      ...
      {
        id: "sales-conversion-today",
        title: "Conversão de propostas",
        value: "24,8%",
        status: "yellow",
        description: "A conversão está abaixo da meta de 32%, com 18 propostas comerciais abertas aguardando avanço.",
        module: "Vendas",
      ...
      {
        id: "critical-alerts-today",
        title: "Alertas críticos e atrasados",
        value: "2 críticos",
        status: "red",
        description: "Dois alertas críticos de Produção estão fora do prazo e exigem decisão das áreas envolvidas.",
        module: "Alertas",
        href: "/alertas?highlight=critical-alerts-today",
      },
      {
        id: "meetings-today",
        title: "Comitê de ruptura e abastecimento",
        value: "Em andamento",
        status: "yellow",
        description: "Produção, Logística e Vendas definem o plano de reposição dos três SKUs críticos.",
        module: "Reuniões",
        href: "/reunioes?highlight=meetings-today",
      },
    ],
  },
  next7: {
    ...
    cards: [
      ...
      {
        id: "alerts-deadline-7d",
        title: "Alertas que exigem reunião",
        value: "4 alertas",
        status: "yellow",
        description: "Quatro alertas de Produção e Vendas dependem de alinhamento entre gestores e Diretoria.",
        module: "Alertas",
        href: "/alertas?highlight=alerts-deadline-7d",
      },
      {
        id: "meetings-planned-7d",
        title: "Planejamento de rotas críticas",
        value: "Amanhã",
        status: "yellow",
        description: "Logística e Produção revisam ocupação da frota, custos e três rotas com risco de atraso.",
        module: "Reuniões",
        href: "/reunioes?highlight=meetings-planned-7d",
      },
    ],
  },
  next30: {
    ...
    cards: [
      ...
      {
        id: "recurring-alerts-30d",
        title: "Alertas operacionais ativos",
        value: "6 alertas",
        status: "yellow",
        description: "A central acompanha seis alertas distribuídos entre Produção, Logística, Vendas e Administrativo.",
        module: "Alertas",
        href: "/alertas?highlight=recurring-alerts-30d",
      },
      {
        id: "meeting-actions-30d",
        title: "Revisão de metas comerciais",
        value: "1 ação pendente",
        status: "yellow",
        description: "Vendas e Financeiro acompanham a contratação de prospecção externa definida na última reunião.",
        module: "Reuniões",
        href: "/reunioes?highlight=meeting-actions-30d",
      },
    ],
  },
};
